...
/* First NULL indicates the auto populated ID number, NULL further on is for iterations as they have not been assigned one yet DO WE NEED ITERATIONS FOR PBI's???? */
...
(NULL, 'Decide on Web Design Frameworks', 'Decide on a Bootstrap template to use', '2', '2', '1', NULL, '1'),
...
(NULL, 'Add coming soon page', '', '3', '2', '1', NULL, '1'),
(NULL, 'Bring coming soon page inline with Brand ID Document', '', '5', '2', '1', NULL, '1'),
(NULL, 'Decide on Project Metrics', 'Be able to show a Release Burndown, multiple burndowns, velocity and an admin page', '1', '2', '1', NULL, '1'),
(NULL, 'Research Graphs', 'A look into what makes a good graph and how they should be presented', '3', '2', '1', NULL, '1'),
(NULL, 'Redesign Database and create ERD', 'Look at whether we need more tables and create an ERD to reflect the design', '16', '2', '1', NULL, '1'),
(NULL, 'Create Physical Data Model', 'Create a data model so that we know what fields attributes are going to have', '5', '2', '1', NULL, '1'),
...
(NULL, 'Populate Database', '', '5', '2', '1', NULL, '1'),
(NULL, 'Get Hosting', 'VidaHost', '3', '2', '1', NULL, '1');
