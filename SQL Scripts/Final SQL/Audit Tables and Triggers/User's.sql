...
VALUES
(NULL, 'Insert', NEW.user_id, NEW.user_forename, NEW.user_surname, NEW.user_email, NEW.user_password, NEW.user_role_id);
...
VALUES
(NULL, 'Update', OLD.user_id, NEW.user_id, OLD.user_forename, NEW.user_forename, OLD.user_surname, NEW.user_surname, OLD.user_email, NEW.user_email, OLD.user_password, NEW.user_password, OLD.user_role_id, NEW.user_role_id);
...
(audit_user, audit_action, user_id, user_forename, user_surname, user_email, user_password, user_role_id)
VALUES
(NULL, 'Delete', OLD.user_id, OLD.user_forename, OLD.user_surname, OLD.user_email, OLD.user_password, OLD.user_role_id);